...
(
	...
	R2Pos_FixP_Current
	(
		INT_TO_FIXED( R2Pos_Int_Initial . x ),
		INT_TO_FIXED( R2Pos_Int_Initial . y )		
	)
{
...
void R2PosDaemon :: SetPos_Int(const r2pos R2Pos_Int_New )
{
	...
	(
		INT_TO_FIXED( R2Pos_Int_Current . x ),
		INT_TO_FIXED( R2Pos_Int_Current . y )
	);
}
...
void R2PosDaemon :: SetPos_FixP(const r2pos R2Pos_FixP_New )
{
	...
	(
		FIXED_TO_INT( R2Pos_FixP_Current . x ),
		FIXED_TO_INT( R2Pos_FixP_Current . y )
	);
}
